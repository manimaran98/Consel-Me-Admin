...
class psyViewBooking extends StatefulWidget {
  const psyViewBooking({key, required this.bookingDetails});

  final String bookingDetails;

  @override
  State<psyViewBooking> createState() => _psyViewBookingState();
}
...
class _psyViewBookingState extends State<psyViewBooking> {
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget yesButton = FlatButton(
      ...
      onPressed: () {
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => const psyHome()));
      },
    );
