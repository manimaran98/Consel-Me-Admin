...
class reportDetails extends StatefulWidget {
  const reportDetails({key, required this.bookingDetails});
...
class _reportDetailsState extends State<reportDetails> {
  ...
  Future getPdf(Uint8List screenShot) async {
    ...
    var code = widget.bookingDetails;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Appoinment Report'),
        centerTitle: true,
  ...
  showAlertDialog(BuildContext context) {
    ...
    Widget yesButton = FlatButton(
      ...
      onPressed: () {
        ...
        Navigator.of(context).pop();
        setState(() {});
        Fluttertoast.showToast(msg: "The Appoinment has Been Deleted");
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: const Text("Are you sure you want to delete this Appoinment?"),
      actions: [
        yesButton,
        noButton,
      ],
